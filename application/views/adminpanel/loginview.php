...
<script text="text/javascrpit">
    function validateForm() {
        ...
        if (document.forms['register']['password'].value != document.forms['register']['cpassword'].value) {
    ...
    <div class="login-reg-panel">
        ...
        <div class="white-panel">
            <div class="login-show">
                <form method="post" action="<?php echo site_url('admin/login/login_post'); ?>">
            ...
            <div class="register-show">
                <form name="register" method="post" action="<?php echo site_url('admin/login/signup_post'); ?>" onsubmit="return validateForm()">

                    <h2>REGISTER</h2>
                    <div class="username">
                        <input type="text" id="first" name="first_name" placeholder="First Name">
                        <input type="text" id="last" name="last_name" placeholder="Last Name"> </div>
                    <input type="email" name="email" placeholder="Email">
                    <div id="CouBirth"> <input type="date" name="birth" placeholder="Birth date">
                        <input type="text" name="occupation" placeholder="Occupation"> </div>
                    <input type="password" name="password" placeholder="Password">
